...
%%%%% Computing the interval of the period of c3 %%%%%%%%%
memoryLen = params3(1);
activeThreshold = params3(2);

m = params3(4);
startPeriod = m+1; 
endPeriod = memoryLen-1; %memoryLen-1;
...
save('VaryingC3_Phase_2.mat', 'All_data');