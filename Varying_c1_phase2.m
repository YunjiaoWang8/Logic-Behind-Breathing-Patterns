...
endPeriod = 56; % a number less than memory lenght for cell 1.
...
for k = 1:num_period
    ...
    % random signal generator in TrajectoryGenerator_4Nodes
...
%% Rewrite the data in a matrix form that could be saved and read in R.
...
save('AllData_varyingc1_totBreath1_phase2.mat', 'All_data')
